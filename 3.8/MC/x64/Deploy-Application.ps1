...
"@
		...
		Write-Log -Message "The final Office 365 ProPlus 64-bit (Monthly Channel) confirugarion will be written at `"$configXmlFilePath`"" -Severity 1 -Source $deployAppScriptFriendlyName
